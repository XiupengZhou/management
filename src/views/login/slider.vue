<template>
  <div class="drag" ref="dragDiv">
    ...
    <div class="flex">
      <!-- <div v-if="lang === 'zh'" class="drag_text zh">{{ confirmWords }}</div> -->
      <div  class="drag_text en flex jc-c">
          <span v-if="!confirmSuccess" class="fix"></span>
          <span class="fg1">{{ confirmWords }}</span>
           <span v-if="confirmSuccess" class="fix"></span>
      </div>
      <div
        ref="moveDiv"
...
export default {
  data() {
    return {
      ...
      confirmWords: this.$t("lang.sliderText") /*滑块文字*/,
  ...
  methods: {
    ...
    successFunction() {
      ...
      this.confirmWords =
        this.$i18n.locale === "zh" ? "验证通过" : "Verification passed";
